...
class ProfilePage extends React.Component<IProps, IState>{
    ...
    render() {
        return (
            <CardPage isLoading={this.state.profile == null || this.state.persona == null} loadingMessage="Getting profile" widthCard="max-content">
                {
                    ...
                    (
                        <div>
                            <Persona
                                ...
                                key="avatar"
                            />
                            <div className="profileContent" key="profile">
